  ...
  slides: [
    {
      content: {
        ...
        avatar:
          "https://decoims.com/loja-integrada/9d73d8b4-5613-4ec2-84ed-f1987e16f4af/7286de42-e9c5-4fcb-ae8b-b992eea4b78e",
        alt: "Avatar",
        name: "Name Surname",
...
function SliderItem(
  ...
  return (
    <div
      id={id}
      class="relative w-full min-h-[292px]"
    >
      <div class="flex flex-col justify-end rounded-[32px] h-full shadow-spreaded2 overflow-hidden pt-7">
        ...
        <div class="flex gap-4 md:gap-5 mt-5 md:mt-11 bg-secondary-content px-6 md:pl-12 md:pr-7 min-h-[86px]">
          ...
          <div class="flex flex-col">
            <div class="mt-5 flex items-center gap-1">
              <svg height="16px" width="16px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" class="text-primary fill-current"
